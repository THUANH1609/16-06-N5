...
# 5. Cài đặt công cụ, môi trường và các thư viện cần thiết
...
## 5.5. Setup tham số chạy cho hệ thống
...
## 5.6 Chạy hệ thống và cài đặt các ứng dụng cần thiết
